	...
	<main>
                ...
                <div id="oleezLandingCarousel" class="oleez-landing-carousel carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="/resources/js_css/assets/images/Banner_1@2x.jpg" alt="First slide" class="w-100">
                        ...
                        <div class="carousel-item">
                            <img src="/resources/js_css/assets/images/Banner_2@2x.jpg" alt="Second slide" class="w-100">
                            <div class="carousel-caption">
                                <h2 data-animation="animated fadeInRight"><span>Remarkable</span></h2>
                                <h2 data-animation="animated fadeInRight"><span>Digital agency</span></h2>
                                <a href="#!" class="carousel-item-link" data-animation="animated fadeInRight">EXPLORE PROJECT</a>
                        ...
                        <div class="carousel-item">
                            <img src="/resources/js_css/assets/images/Banner_3@2x.jpg" alt="Third slide" class="w-100">
                            <div class="carousel-caption">
                                <h2 data-animation="animated fadeInRight"><span>Remarkable</span></h2>
                                <h2 data-animation="animated fadeInRight"><span>Digital agency</span></h2>
                                <a href="#!" class="carousel-item-link" data-animation="animated fadeInRight">EXPLORE PROJECT</a>
                        ...
                        <div class="carousel-item">
                            <img src="/resources/js_css/assets/images/Banner_4@2x.jpg" alt="Fourth slide" class="w-100">
                            <div class="carousel-caption">
                                <h2 data-animation="animated fadeInRight"><span>Remarkable</span></h2>
                                <h2 data-animation="animated fadeInRight"><span>Digital agency</span></h2>
                                <a href="#!" class="carousel-item-link" data-animation="animated fadeInRight">EXPLORE PROJECT</a>
            ...
            <div class="container">
                <div class="oleez-landing-section-content">
                    <div class="oleez-landing-section-verticals wow fadeIn">
                        <span class="number">01</span> <img src="/resources/js_css/assets/images/Logo_2.svg" alt="ollez" height="12px">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 landing-about-feature wow fadeInUp">
                            <img src="/resources/js_css/assets/images/icon_1.svg" alt="document" class="about-feature-icon">
                        ...
                        <div class="col-md-4 landing-about-feature wow fadeInUp">
                            <img src="/resources/js_css/assets/images/icon_2.svg" alt="document" class="about-feature-icon">
                            <h5 class="about-feature-title">Wireframe/Sketch</h5>
                            <p class="about-feature-description">Lorem Ipsum is simply text the printing and typesetting standard industry.</p>
                        </div>
                        <div class="col-md-4 landing-about-feature wow fadeInUp">
                            <img src="/resources/js_css/assets/images/icon_3.svg" alt="document" class="about-feature-icon">
        ...
        <section class="oleez-landing-section oleez-landing-section-projects">
            <div class="container">
                <div class="oleez-landing-section-content">
                    <div class="oleez-landing-section-verticals wow fadeIn">
                        <span class="number">02</span> <img src="/resources/js_css/assets/images/Logo_2.svg" alt="oleez" height="12px">
                    </div>
                    ...
                    <div class="landing-projects-carousel wow fadeIn">
                        <div class="card landing-project-card">
                            <img src="/resources/js_css/assets/images/Project_1@2x.jpg" class="card-img" alt="Project 1">
                        ...
                        <div class="card landing-project-card">
                            <img src="/resources/js_css/assets/images/Project_2@2x.jpg" class="card-img" alt="Project 1">
                            <div class="card-img-overlay">
                                <h6 class="project-category">Branding</h6>
                                <h5 class="project-title">BootstrapDash</h5>
                            </div>
                        ...
                        <div class="card landing-project-card">
                            <img src="/resources/js_css/assets/images/Project_3@2x.jpg" class="card-img" alt="Project 1">
                            <div class="card-img-overlay">
                                <h6 class="project-category">Branding</h6>
                                <h5 class="project-title">BootstrapDash</h5>
                            </div>
                        ...
                        <div class="card landing-project-card">
                            <img src="/resources/js_css/assets/images/Project_4@2x.jpg" class="card-img" alt="Project 1">
                            <div class="card-img-overlay">
                                <h6 class="project-category">Branding</h6>
                                <h5 class="project-title">BootstrapDash</h5>
                            </div>
        ...
        <section class="oleez-landing-section oleez-landing-section-team">
            <div class="container">
                <div class="oleez-landing-section-content">
                    <div class="oleez-landing-section-verticals wow fadeIn">
                        <span class="number">03</span> <img src="/resources/js_css/assets/images/Logo_2.svg" alt="ollez" height="12px">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-5 mb-md-0 landing-team-card wow flipInY">
                            <img src="/resources/js_css/assets/images/Team_3@2x.jpg" alt="Team Member" class="team-card-img">
                        ...
                        <div class="col-md-4 mb-5 mb-md-0 landing-team-card wow flipInY">
                                <img src="/resources/js_css/assets/images/Team_2@2x.jpg" alt="Team Member" class="team-card-img">
                        ...
                        <div class="col-md-4 mb-5 mb-md-0 landing-team-card wow flipInY">
                                <img src="/resources/js_css/assets/images/Team_1@2x.jpg" alt="Team Member" class="team-card-img">
        ...
        <section class="oleez-landing-section oleez-landing-section-client">
            <div class="container">
                <div class="oleez-landing-section-content">
                    <div class="oleez-landing-section-verticals wow fadeIn">
                        <span class="number">04</span> <img src="/resources/js_css/assets/images/Logo_2.svg" alt="ollez" height="12px">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 client-logo-wrapper wow flipInX">
                            <div class="client-logo">
                                <img src="/resources/js_css/assets/images/client_4.png" alt="client" height="50px">
                            </div>
                        </div>
                        <div class="col-md-4 client-logo-wrapper wow flipInX">
                            <div class="client-logo">
                                <img src="/resources/js_css/assets/images/client_2.png" alt="client" height="50px">
                            </div>
                        </div>
                        <div class="col-md-4 client-logo-wrapper wow flipInX">
                            <div class="client-logo">
                                <img src="/resources/js_css/assets/images/client_1.png" alt="client" height="50px">
                            </div>
                        </div>
                        <div class="col-md-4 client-logo-wrapper wow flipInX">
                            <div class="client-logo">
                                <img src="/resources/js_css/assets/images/client_6.png" alt="client" height="50px">
                            </div>
                        </div>
                        <div class="col-md-4 client-logo-wrapper wow flipInX">
                            <div class="client-logo">
                                <img src="/resources/js_css/assets/images/client_3.png" alt="client" height="50px">
                            </div>
                        </div>
                        <div class="col-md-4 client-logo-wrapper wow flipInX">
                            <div class="client-logo">
                                <img src="/resources/js_css/assets/images/client_5.png" alt="client" height="50px">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="oleez-landing-section oleez-landing-section-news">
            <div class="container">
                <div class="oleez-landing-section-content">
                    <div class="oleez-landing-section-verticals wow fadeIn">
                        <span class="number">05</span> <img src="/resources/js_css/assets/images/Logo_2.svg" alt="ollez" height="12px">
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="news-card news-card-1 wow fadeInUp">
                                <div class="card-body">
                                    <div class="author-info media">
                                        <img src="/resources/js_css/assets/images/Team_1_Copy_2@2x.jpg" alt="author" class="author-avatar">
                        ...
                        <div class="col-lg-4 mb-4 mb-lg-0">
                            <div class="news-card news-card-2 wow fadeInUp">
                                <div class="card-body">
                                    <div class="author-info media">
                                        <img src="/resources/js_css/assets/images/Team_2_Copy_2@2x.jpg" alt="author" class="author-avatar">
                                        <div class="media-body">
                        ...
                        <div class="col-lg-4 mb-4 mb-lg-0">
                            <div class="news-card news-card-3 wow fadeInUp">
                                <div class="card-body">
                                    <div class="author-info media">
                                        <img src="/resources/js_css/assets/images/Team_3_Copy_2@2x.jpg" alt="author" class="author-avatar">
                                        <div class="media-body">
                ...
                <div class="oleez-landing-section-content">
                    ...
                    <div class="landing-testimonial-carousel wow fadeInUp">
                        <div class="landing-testimonial-card">
                            <div class="media">
                                <img src="/resources/js_css/assets/images/Client_1@2x.jpg" alt="client" class="testimonial-card-img">
                                <div class="media-body">
                        ...
                        <div class="landing-testimonial-card">
                            <div class="media">
                                <img src="/resources/js_css/assets/images/Client_2@2x.jpg" alt="client" class="testimonial-card-img">
                                <div class="media-body">
                                    <p class="testimonial-card-content">
                                        The revulsion in our feelings was therefore all the greater when the car suddenly escaped from this height of desolation, and a magnificent prospect burst upon our view.
                                    </p>
                        ...
                        <div class="landing-testimonial-card">
                            <div class="media">
                                <img src="/resources/js_css/assets/images/Client_3@2x.jpg" alt="client" class="testimonial-card-img">
                                <div class="media-body">
                                    <p class="testimonial-card-content">
                                        The revulsion in our feelings was therefore all the greater when the car suddenly escaped from this height of desolation, and a magnificent prospect burst upon our view.
                                    </p>
                        ...
                        <div class="landing-testimonial-card">
                            <div class="media">
                                <img src="/resources/js_css/assets/images/Client_4@2x.jpg" alt="client" class="testimonial-card-img">
                                <div class="media-body">
                                    <p class="testimonial-card-content">
                                        The revulsion in our feelings was therefore all the greater when the car suddenly escaped from this height of desolation, and a magnificent prospect burst upon our view.
                                    </p>
