...
mucho más simple por la menor cantidad de datos de tipo vs evento
			...
			<form class="row g-3 needs-validation justify-content-center"
				...
				<c:if test="${accion.equals('EDICIÓN')}">
					<article class="col-md-4">
						<label for="idInput" class="form-label">ID Tipo</label> <input
							type="text" name="idTipo" class="form-control" id="idInput"
							value="${tipo.idTipo}" required readonly>
					</article>
